...
LED_COUNT      = 165     # Number of LED pixels.
...
day_phases = [
    DayPhase(name='midnight', color=(0, 8, 0, 0), time='12:00:00 AM', steps=0),
    DayPhase(name='first_light', color=(0, 30, 0, 8), time=None, steps=0),
    DayPhase(name='dawn', color=(90, 0, 15, 30), time=None, steps=0),
    DayPhase(name='sunrise', color=(120, 0, 25, 45), time=None, steps=0),
    DayPhase(name='solar_noon', color=(200, 255, 190, 255), time=None, steps=0),
    DayPhase(name='golden_hour', color=(255, 0, 20, 90), time=None, steps=0),
    DayPhase(name='sunset', color=(200, 0, 10, 125), time=None, steps=0),
    DayPhase(name='dusk', color=(15, 40, 20, 10), time=None, steps=0),
    DayPhase(name='last_light', color=(0, 10, 0, 0), time=None, steps=0),
    DayPhase(name='midnight2', color=(0, 8, 0, 0), time='11:59:59 PM', steps=0),
    ]
