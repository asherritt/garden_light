...
phase_colors = [
    PhaseColor(
        name='midnight',
        lamps_on=True,
        fill_light = [(80, 105, 120, 90), (65, 115, 120, 100), (65, 130, 100, 80)],
        cyc = [
            (36, 39, 45),
            (26, 48, 120),
            (44, 35, 27),
    ...
    PhaseColor(
        name='first_light',
        lamps_on=True,
        fill_light = [(55, 75, 45, 65), (45, 80, 45, 65), (45, 95, 45, 55)],
        cyc = [
            (36, 39, 45),
            (33, 60, 158),
            (44, 35, 27),
    ...
    PhaseColor(
        name='dusk',
        lamps_on=True,
        fill_light=[(70, 70, 0, 50), (65, 95, 0, 60), (60, 90, 0, 50)],
        cyc=[
            (95, 85, 94),
            (72, 98, 200),
            (112, 79, 68),
    ...
    PhaseColor(
        name='last_light',
        lamps_on=True,
        fill_light = [(80, 105, 130, 90), (65, 115, 120, 100), (65, 130, 180, 80)],
        cyc = [
            (16, 29, 45),
            (26, 48, 120),
            (44, 35, 27),
