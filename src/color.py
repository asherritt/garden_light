...
phase_colors = [
    PhaseColor(
        name='midnight',
        lamps_on=True,
        fill_light=[(91, 99, 115, 70), (37, 37, 71, 50), (81, 85, 94, 50)],
        cyc=[
            (81, 85, 94),
            (77, 115, 255),
            (92, 79, 68),
    ...
    PhaseColor(
        name='first_light',
        lamps_on=True,
        fill_light=[(77, 115, 255, 80), (150, 20, 180, 80), (77, 115, 255, 80)],
        cyc=[
            (191, 201, 255),
            (187, 158, 255),
            (77, 115, 255),
    ...
    PhaseColor(
        name='dawn',
        lamps_on=False,
        fill_light=[(186, 255, 218, 255), (77, 115, 255, 200), (173, 184, 218, 255)],
        cyc=[
            (255, 206, 145),
            (186, 255, 218),
            (158, 161, 255),
    ...
    PhaseColor(
        name='sunrise',
        lamps_on=False,
        fill_light=[(255, 196, 87, 255), (242, 255, 251, 100), (242, 188, 112, 200)],
        cyc=[
            (255, 196, 87),
            (255, 176, 107),
            (255, 188, 112),
    ...
    PhaseColor(
        name='solar_noon',
        lamps_on=False,
        fill_light=[(255, 209, 171, 255), (255, 188, 112, 255), (255, 237, 199, 200)],
        cyc=[
            (255, 209, 171),
            (255, 216, 214),
            (255, 188, 112),
    ...
    PhaseColor(
        name='golden_hour',
        lamps_on=False,
        fill_light=[(255, 195, 166, 245), (255, 197, 158, 90), (255, 222, 217, 180)],
        cyc=[
            (255, 195, 166),
            (255, 222, 217),
            (255, 166, 115),
    ...
    PhaseColor(
        name='sunset',
        lamps_on=False,
        fill_light=[(255, 223, 204, 200), (255, 137, 64, 255), (255, 67, 20, 240)],
        cyc=[
            (227, 191, 255),
            (255, 223, 204),
            (255, 155, 97),
    ...
    PhaseColor(
        name='dusk',
        lamps_on=True,
        fill_light=[(255, 209, 253, 200), (184, 198, 255, 255), (255, 209, 253, 255)],
        cyc=[
            (255, 209, 253),
            (184, 198, 255),
            (255, 209, 253),
    ...
    PhaseColor(
        name='last_light',
        lamps_on=True,
        fill_light=[(145, 202, 180, 200), (145, 180, 255, 180), (145, 202, 255, 145)],
        cyc=[
            (145, 202, 180),
            (145, 202, 200),
            (145, 202, 220),
